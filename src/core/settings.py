...
__default_settings: list = [
    ...
    },
    {
        ...
        'elements': [
            ...
            checkBox(tr('Archive'), toggled=False, sub_pos=1, advanced=True, id='archive'),
            checkBox(tr('System'), toggled=False, sub_pos=1, advanced=True, id='system'),
            ...
            checkBox(tr('Temporary'), toggled=False, sub_pos=1, advanced=True, id='temporary'),
    ...
    },
    {
        ...
        'elements': [
            ...
            checkBox(tr('Auditing Information'), toggled=False, sub_pos=1, advanced=True, id='audit_info'),
