...
class SettingWPushButtons(QFSettingCard):
    def __init__(self, icon: FluentIcon, title: str, label: str, button_labels: tuple[str, ...], button_clicked_slots: tuple[callable, ...]):
...
class SettingWComboBox(QFSettingCard):
    def __init__(self, icon: FluentIcon, title: str, label: str, items: tuple[str, ...], selected_item: int, item_selected_slot: callable):
